...
def generateOutline(transcriptDirectory, videoId, outlineDirectory):
    # 檢查目錄
    ...
    with open(transcriptFilePath, "r", encoding="utf-8") as transcriptFile:
        parts = transcriptFile.read()
